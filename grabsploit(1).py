...
print(f"""
      ...
      {red}VIRUS DETECTED{reset}
 
 [                              B8  {green}42{reset}  {red}4E{reset}  D9  {green}29  {red}2C{reset}    ]
 [                              {red}4F{reset}  {green}08{reset}  {green}63{reset}  {red}3C{reset}  E6  F6    ]
 [                              {red}3D{reset}  {green}43{reset}  {green}42{reset}  C2  {red}3D{reset}        ]
 [                              22  93  96  C8  FB        ]
 [                              {green}62{reset}  A6  {red}3F{reset}  C3  {green}03{reset}  E7    ]
 [                              00  10  1D  CC  6C  21    ]
 ...............................GR  AN  {yellow}L   S   F{reset}   H9
 [                              {red}4C{reset}  {red}1A{reset}  {green}1E{reset}  {red}8A{reset}  {green}83{reset}        ]
 [                              FF  F3  00  E2  62  55    ]
 [                              FB  56  55  3E  F7  39    ]
 [                              F1  {green}45{reset}  D7  {green}64{reset}  C3  D3    ]
 [                              E7  {green}80{reset}  {red}5P{reset}  FF  E3  BA    ]
 [                              {green}45{reset}  {green}32{reset}  {green}52{reset}  F0  {red}1T{reset}  {green}40{reset}    ]
 [                              D3  D5  95  A6  F8  C0    ]
 [                              M3  {green}34{reset}  F8  A5  {green}34{reset}  C7    ]
 [                              DC  F9  18  ED  CC  0F    ]
 [                              BB  F5  {green}11{reset}  FF  {green}30{reset}  {green}31{reset}    ]




----[ {yellow} version 0.2.2{reset}             ]----
